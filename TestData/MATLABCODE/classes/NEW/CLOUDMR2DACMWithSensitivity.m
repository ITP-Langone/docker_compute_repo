classdef CLOUDMR2DACMWithSensitivity<CLOUDMR2DACM
    ...
    %v25022020
    properties
        CoilSensitivityMap %Smap
        SourceCoilSensitivityMap %the matrix for the sensitivity calculation to be set
        SensitivityCalculationMethod %'simplesense' ,'adaptive'
        SourceCoilSensitivityMapNCoils %nuber of coils
        SourceCoilSensitivityMapID %just to get the name of the file in db of the coil sens
        SaveCoils
    ...
    methods
        ...
        function setSensitivityMatrix(this,S)
            this.CoilSensitivityMap=S;
            
        end
            
        function resetSensitivityMatrix(this)
                ...
                if (~isempty(this.SourceCoilSensitivityMap))
                    ...
                    switch(lower(this.SensitivityCalculationMethod))
                        case {'espirit'}
                            ...
                            coilsens_set = espirit_sensitivitymap(this.SourceCoilSensitivityMap);                         
